import common
from common import PodType, ConnectionType, TestCaseType
...
class TrafficFlowTests():
    ...
    def run(self):
        ...
        #s = IperfServer(self._tft, index, node_server_name, False, self.server_test_to_pod_type(test_id, pod_type), True)
        #c = IperfClient(self._tft, s, index, node_client_name, self.client_test_to_pod_type(test_id, pod_type), True)
        servers.append(s)
        clients.append(c)
